...
const MANIFEST: Record<string, GateSpec> = {
	...
	smoke_agent_liveness: { kind: "assert" },
	...
	smoke_budget_softcap: { kind: "assert" },
	...
	smoke_frame_headline_strict: { kind: "assert" },
	smoke_pi_gate_escalation: { kind: "assert" },
	...
	smoke_model_routing: { kind: "assert" },
	smoke_refusal_regression: { kind: "assert" },
