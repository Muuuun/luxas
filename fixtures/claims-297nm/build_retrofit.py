...
io.open(f"{OUT}/reviews/experiment_review_E5_blockade_floor_master_equation_r1.md", "w", encoding="utf-8").write("""# experiment_reviewer — E5 (retrofit fixture; harness-named file, lines per design §3.5)
